...
class CircularProgressMultiBar extends StatefulWidget {
  final double? size;
  //final double? width;
  const CircularProgressMultiBar({Key? key, this.size}) : super(key: key);

  @override
  _CircularProgressMultiBarState createState() => _CircularProgressMultiBarState();
}

class _CircularProgressMultiBarState extends State<CircularProgressMultiBar>
